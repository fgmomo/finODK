...
class VisiteurAllAttenteConsultationScreen extends StatefulWidget {
  const VisiteurAllAttenteConsultationScreen({super.key});

  @override
  State<VisiteurAllAttenteConsultationScreen> createState() =>
      _VisiteurAllAttenteConsultationScreenState();
}

class _VisiteurAllAttenteConsultationScreenState
    extends State<VisiteurAllAttenteConsultationScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchAndSetConsultations() async {
    allConsultations = await ConsultationService().fetchConsultationsAttVisiteur();
    setState(() {
