...
class VisitorEditProfilScreen extends StatefulWidget {
  const VisitorEditProfilScreen({super.key});

  @override
  State<VisitorEditProfilScreen> createState() =>
      _VisitorEditProfilScreenState();
}

class _VisitorEditProfilScreenState extends State<VisitorEditProfilScreen> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await FirebaseFirestore.instance
          ...
          if (imageUrl != null) 'profileImageUrl': imageUrl, // Ajoutez l'URL de l'image
        });
          ...
          TextButton(
            onPressed: () {
              ...
              Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                  builder: (context) => VisitorProfilScreen(), // Remplacez par votre écran de profil
                ),
              );
            },
            child: Text(
